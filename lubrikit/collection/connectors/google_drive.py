"""Google Drive connector for downloading files from Google Drive.
...
Drive using service account authentication.
...
.. code-block:: python
    ...
    from lubrikit.collection.connectors.configs import GoogleDriveConfig

    # Configure the file to download
    config = GoogleDriveConfig(file_id="1BxiMVs0XRA5nFMdKvBdBZjgmUUqptlbs74OgvE2upms")
...
For more examples, see the GoogleDriveConnector class documentation.
"""
...
class GoogleDriveConnector(BaseConnector):
    ...
    This connector allows you to check and download files from Google
    ...
    Example:
        ...
        # Configure the file to download
        config = GoogleDriveConfig(file_id="[YOUR_FILE_ID]")

        # Create connector instance
        connector = GoogleDriveConnector(config=config, headers_cache=headers_cache)
    ...
    def __init__(
        ...
        self.service_account_info: GoogleDriveServiceAccountInfo
